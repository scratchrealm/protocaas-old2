...
const WorkspaceUsersComponent: FunctionComponent<Props> = () => {
    const {workspace, setWorkspaceUsers, setWorkspaceListed, setWorkspacePubliclyReadable, workspaceRole} = useWorkspace()
    ...
    const setPubliclyReadableHandler = useCallback(async (readable: boolean) => {
        await setWorkspacePubliclyReadable(readable)
    }, [setWorkspacePubliclyReadable])

    const setListedHandler = useCallback(async (listed: boolean) => {
        await setWorkspaceListed(listed)
    }, [setWorkspaceListed])
